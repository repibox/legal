Our [Privacy Policy](https://github.com/repibox/legal/blob/master/Privacy-Policy.md) explains our principles when it comes to the collection, processing, and storage of your information. This policy specifically explains how we, our partners, and users of our services deploy cookies, as well as the options you have to control them.
...
*   On our websites (including repibox.com, larecipe.com, repibox.github.io).
*   In the dashboards of our websites, such as Repibox.
...
|Cookie|Purpose|
|--- |--- |
|__pdvt|Used in log of survey data to aid in debugging customer problems|
|_hjIncludedInSample
...
|wp-affiliate-tracker|Remembers the ID of the affiliate that referred the current user to Repibox.com|
...
|Cookie|Purpose|
|--- |--- |
|csrftoken|Python/Ajax security cookie used when signing in to an account.|
...
|Partner|Cookie Info|
|--- |--- |
|No Advertising Partners at this time | |
...
If you have any questions about our use of cookies, you can find the most relevant contact details in our [Privacy Policy](https://github.com/repibox/legal/blob/master/Privacy-Policy.md).
